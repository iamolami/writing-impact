        ...
        <div className="footer__wrapper">
          ...
          <div className="footer__lowerBox">
            <p>
              ...
              Reserved. <a href="/cookie-policy" className="footer__lowerBox-a">Cookie policy</a> |
              <a href="/privacy-policy" className="footer__lowerBox-a"> Privacy policy</a> |
              <a href="/terms-of-use" className="footer__lowerBox-a"> Terms of use</a>
            </p>
          </div>
        </div>
      </div>
